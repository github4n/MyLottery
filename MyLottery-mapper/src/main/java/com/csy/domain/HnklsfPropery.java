...
//湖南快乐十分
public class HnklsfPropery extends BaseDomain{
    private String sKey;
    ...
    public String getsSumTailSize() {
        return sSumTailSize;
    }

    public void setsSumTailSize(String sSumTailSize) {
        this.sSumTailSize = sSumTailSize == null ? null : sSumTailSize.trim();
    }

...
//北京pk10
public class Bjpk10Property extends BaseDomain{
    private String sKey;

    private Integer iGYSum;

    private String sGYBigSmall;

    private String sGYSingleDouble;
    ...
    private String sDragonTigerNum5;
    ...
    public Integer getiGYSum() {
        return iGYSum;
    }

    public void setiGYSum(Integer iGYSum) {
        this.iGYSum = iGYSum;
    }

    public String getsGYBigSmall() {
        return sGYBigSmall;
    }

    public void setsGYBigSmall(String sGYBigSmall) {
        this.sGYBigSmall = sGYBigSmall == null ? null : sGYBigSmall.trim();
    }

    public String getsGYSingleDouble() {
        return sGYSingleDouble;
    }

    public void setsGYSingleDouble(String sGYSingleDouble) {
        this.sGYSingleDouble = sGYSingleDouble == null ? null : sGYSingleDouble.trim();
    }
    ...
    public String getsDragonTigerNum5() {
        return sDragonTigerNum5;
    }

    public void setsDragonTigerNum5(String sDragonTigerNum5) {
        this.sDragonTigerNum5 = sDragonTigerNum5 == null ? null : sDragonTigerNum5.trim();
    }
}